...
public class Arwen extends NPC {
    ...
    private DialogueNode buildLevel1Tree() {
        ...
        // ===== END nodes =====
        DialogueNode endBad   = new DialogueNode("Arwen", "(สายตาเย็นชา) ไม่มีอะไรจะพูดแล้ว... หลีกทางด้วย", true);
        DialogueNode endGood  = new DialogueNode("Arwen", "(ผายมือ) ก็ได้... เจอกันใหม่นะ ถ้าไม่ตายเสียก่อน", true);
        DialogueNode endNormal= new DialogueNode("Arwen", "(เดินจากไป) ...", true);
        DialogueNode endBest  = new DialogueNode("Arwen", "(ตบหลังแรงๆ แล้วเดินนำ) ตามมาได้เลย! อย่าเตะตีนข้าล่ะ!", true);
