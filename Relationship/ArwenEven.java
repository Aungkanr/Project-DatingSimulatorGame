...
public class ArwenEven extends Arwen {
    ...
    private DialogueNode buildLevel1Tree(MainFrame mainFrame) {
        ...
        n1_5A.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\(ยื่นของให้พร้อมรอยยิ้มหวานที่สุด) _นี่ค่ะ... ยินดีต้อนรับสู่หมู่บ้านของเรานะคะ หวังว่าเราจะได้คุยกันบ่อยๆ นะคะท่าน_.png";
        ...
        n1_5B.imagePath = "image\\Scene\\Arwen\\Scene1\\(เธอกำลังคนหม้อปรุงยาใบใหญ่ที่ส่งควันโขมงหน้าบ้าน) อ๊ะ! ท่าน... ท่านคือเพื่อนบ้านคนใหม่ใช่ไหมคะ_ ข้าขอโทษด้วยนะคะถ้ากลิ่นสมุนไพรรบกวนท่าน.png";
        ...
        n1_5C.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_ค่ะ... ไว้เจอกันโอกาสหน้านะคะ (ยิ้มตามมารยาท)_.png";
        ...
        n1_4A.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_เย้! ข้าดีใจที่ท่านชอบ! ...งั้นเดี๋ยวข้าจะแบ่งใส่ขวดให้ท่านเอากลับไปทานที่บ้านด้วยนะคะ รอสักครู่นะ_.png";
        ...
        n1_4B.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_ข้าหวังว่าคราวหน้าข้าจะทำสิ่งที่ถูกปากท่านได้บ้าง... ข้าอยากเป็นเพื่อนบ้านที่ดีของท่านนะคะ_.png";
        ...
        n1_4C.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_ถ้าขาดเหลืออะไร บอกข้าได้เสมอเลยนะคะ... เดินทางกลับบ้านปลอดภัยนะคะ ท่านเพื่อนบ้าน_.png";
        ...
        n1_3A.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\(ตักยาใส่ถ้วยยื่นให้) _ระวังร้อนนะคะ... ค่อยๆ จิบนะ... รสชาติเป็นอย่างไรบ้างคะ_.png";
        ...
        n1_3B.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_น่าเสียดายจัง... แต่ไม่เป็นไรค่ะ งั้นข้าจะห่อขนมปังอบแห้งให้ท่านแทนละกันนะคะ รับไว้เถอะนะ ถือเป็นการต้อนรับ_.png";
        ...
        n1_3C.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_ช่วยให้นอนหลับสบายและฝันดีค่ะ... ข้าตั้งใจปรุงสุดฝีมือเลยนะ ท่านไม่ลองจริงๆ เหรอ_.png";
        ...
        n1_2A.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\(ยิ้มกว้าง) _ท่านจมูกไวมาก! นี่คือ _ยาวิเศษคลายกังวล_ ค่ะ ข้าปรุงไว้แจกคนในหมู่บ้าน... ท่านสนใจจะลองชิมเป็นคนแรกไหมคะ_.png";
        ...
        n1_2B.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\(หน้าสลดลง) _ข...ขอโทษจริงๆ ค่ะ! ข้าจะรีบดับไฟเดี๋ยวนี้แหละ... ท่านอย่าโกรธเลยนะ_.png";
        ...
        n1_2C.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\_เย้! ข้าดีใจที่ท่านชอบ! ...งั้นเดี๋ยวข้าจะแบ่งใส่ขวดให้ท่านเอากลับไปทานที่บ้านด้วยนะคะ รอสักครู่นะ_.png";
        ...
        root.imagePath = "image\\Scene\\Arwen\\Scene1\\Even\\(เธอกำลังคนหม้อปรุงยาใบใหญ่ที่ส่งควันโขมงหน้าบ้าน) อ๊ะ! ท่าน... ท่านคือเพื่อนบ้านคนใหม่ใช่ไหมคะ_ ข้าขอโทษด้วยนะคะถ้ากลิ่นสมุนไพรรบกวนท่าน.png";
    ...
    private DialogueNode buildLevel2Tree(MainFrame mainFrame) {
        ...
        n2_5A.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\(ทายาให้อย่างเบามือแล้วเป่าเบาๆ) _เรียบร้อยค่ะ... หายไวๆ นะคะท่านอัศวิน... (หน้าแดงเล็กน้อย) ข้า... ข้ามีความสุขที่ได้ดูแลท่านนะ_.png";
        ...
        n2_5B.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ดูแลตัวเองดีๆ นะคะ ข้าไม่อยากเห็นท่านเจ็บตัวเลย... ถ้าต้องการสมุนไพรเพิ่ม มาหาข้าได้เสมอนะ_.png";
        ...
        n2_5C.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ค่ะ... เข้าใจแล้วค่ะ ข้าคงจุ้นจ้านเกินไป... ขอตัวนะคะ_ (เดินกลับบ้านไปเงียบๆ).png";
        ...
        n2_4A.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ไม่ได้นะคะ! แผลเล็กๆ ก็ติดเชื้อได้... รอเดี๋ยวนะคะ ข้าพกขี้ผึ้งสมานแผลมาด้วยพอดี (หยิบตลับยาออกมา)_.png";
        ...
        n2_4B.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ถึงจะไกลหัวใจก็ต้องดูแลนะคะ... มาค่ะ ข้าจะเป่าเพี้ยงให้... เหมือนตอนข้าทำให้หลานๆ มันช่วยให้หายเจ็บได้จริงๆ นะ_.png";
        ...
        n2_4C.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ท่านนี่ดื้อเงียบเหมือนกันนะคะเนี่ย... เอาล่ะ ข้าไม่กวนแล้ว ทานขนมปังให้อร่อยนะคะ_.png";
        ...
        n2_3A.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ทานตอนร้อนๆ อร่อยที่สุดนะคะ... เอ๊ะ_ มือท่าน... มีแผลนี่คะ_ ไปโดนอะไรมา_.png";
        ...
        n2_3B.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_สูตรนี้ใส่ผลไม้แห้งด้วยนะคะ รับรองว่าอร่อย... แต่ว่า... สีหน้าท่านดูเพลียๆ นะคะ ไม่สบายตรงไหนหรือเปล่า_.png";
        ...
        n2_2A.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\(ยิ้มโล่งอก) _ดีจังเลยค่ะ... คือว่าเมื่อเช้าข้าอบขนมปังธัญพืชสูตรพิเศษ กลิ่นมันหอมฟุ้งจนข้าอดคิดถึงท่านไม่ได้ เลยอยากเอามาแบ่งน่ะค่ะ_.png";
        ...
        n2_2B.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\_ว้าย! ข้าขอโทษจริงๆ ค่ะที่มารบกวนเวลาพักผ่อน... ข้าแค่ตั้งใจจะเอาขนมปังมาแขวนไว้ให้เฉยๆ ไม่นึกว่าท่านจะออกมา_.png";
        ...
        root.imagePath = "image\\Scene\\Arwen\\Scene2\\Even\\(ยืนถือตะกร้าหวายที่มีผ้าคลุมอยู่หน้าบ้านคุณ) _สวัสดีค่ะท่านเพื่อนบ้าน! ข้า... ข้ามารบกวนท่านหรือเปล่าคะ_.png";
    ...
    private DialogueNode buildLevel3Tree(MainFrame mainFrame) {
        ...
        n3_5A.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(หลังจากรอดมาได้ เธอเข้ามากอดคุณแน่น) _ขอบคุณจริงๆ ค่ะ... ถ้าไม่มีท่าน ข้าต้องแย่แน่ๆ... ท่านคือผู้ช่วยชีวิตของข้าเลยนะคะ_.png";
        ...
        n3_5B.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\_วันนี้เหนื่อยหน่อยนะคะ... กลับไปถึงบ้าน ข้าจะทำซุปอุ่นๆ ให้ท่านทานเป็นการตอบแทนนะ.png";
        ...
        n3_5C.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\_ถึงจะไม่ได้สมุนไพรครบ... แต่ข้าก็ขอบคุณที่ท่านอุตส่าห์มาเป็นเพื่อนนะคะ... (ยิ้มเศร้าๆ)_.png";
        ...
        n3_4A.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(เจอสมุนไพรแล้ว!) _เจอแล้ว! อยู่นี่เอง! ...แต่ เอ๊ะ_ มีมอนสเตอร์ตัวใหญ่ขวางอยู่! เราจะทำยังไงดีคะ_.png";
        ...
        n3_4B.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\_ท่านสู้เก่งมากเลยค่ะ! (มองดูคุณสู้กับพวกมอนสเตอร์) ข้าไม่เคยเห็นใครเท่เท่าท่านมาก่อนเลย..._.png";
        ...
        n3_4C.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\ขอโทษค่ะ... ข้าจะพยายามเดินให้เร็วขึ้น... (เธอกึ่งวิ่งกึ่งเดินจนเกือบจะสะดุดล้ม).png";
        ...
        n3_3A.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(ขณะที่เดินไปในป่า เธอกุมมือคุณแน่น) _ขอบคุณที่อยู่ข้างๆ นะคะ... ท่านดูพึ่งพาได้มากเลย ข้ารู้สึกปลอดภัยจัง_.png";
        ...
        n3_3B.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\_ระวังตัวด้วยนะคะ! พวกมันนิสัยเสียชอบลอบกัด... ข้าจะเป็นกำลังใจให้ท่านอยู่ตรงนี้นะคะ_.png";
        n3_3B.addChoice("เพื่อคุณ... แค่นี้สบายมากครับ", n3_4A,
                () -> mainFrame.getPlayer().getArwen().addAffection(5))
             .addChoice("เตรียมยาแผลไว้รอผมได้เลย", n3_4B,
                () -> mainFrame.getPlayer().getArwen().addAffection(3))
             .addChoice("อย่าลืมทำขนมรอเป็นรางวัลด้วยล่ะ", n3_4C,
                () -> mainFrame.getPlayer().getArwen().addAffection(3));
        ...
        n3_3C.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(ถอนหายใจยาว) _ถ้าท่านไม่สะดวกก็ไม่เป็นไรค่ะ... ข้าจะลองหาทางอื่นดู... ขอบคุณที่รับฟังนะคะ_.png";
        ...
        n3_2A.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(เงยหน้ามองคุณอย่างมีความหวัง) _ขอบคุณนะคะ! ข้าจำได้ว่าเอาไปวางไว้แถวๆ สวนหลังหมู่บ้าน... แต่แถวนั้นมอนสเตอร์เยอะมาก ข้าเลยไม่กล้าเข้าไป_.png";
        ...
        n3_2B.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\_ข้านึกจนหัวจะระเบิดแล้วค่ะ... (กุมขมับ) หรือว่าข้าจะโดนพวกก็อบลินขโมยไปนะ_ ข้าเห็นมันด้อมๆ มองๆ อยู่เมื่อเช้า_.png";
        ...
        n3_2C.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(น้ำตาคลอเบ้า) _ข้า... ข้าขอโทษค่ะ ข้าไม่ได้ตั้งใจ... มันสำคัญมากจริงๆ เพราะถ้าไม่มีมัน คนป่วยในหมู่บ้านจะแย่ลง..._.png";
        ...
        root.imagePath = "image\\Scene\\Arwen\\Scene3\\Even\\(เธอนั่งอยู่กลางกองสมุนไพรที่กระจัดกระจาย หน้าตาดูเคร่งเครียด) _แย่แล้วค่ะ... ยาสมุนไพรที่ข้าเตรียมไว้ให้คนป่วยหายไปไหนหมดไม่รู้! ข้าต้องหาให้เจอภายในเย็นนี้_.png";
    ...
    private DialogueNode buildLevel4Tree(MainFrame mainFrame) {
        ...
        n4_5A.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(กระซิบข้างหูเบาๆ ก่อนแยกจากกัน) _ข้ารักท่านนะ... เจ้ามนุษย์ใจดีของข้า_.png";
        ...
        n4_5B.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\_ข้าเข้าใจค่ะ... บางทีความสัมพันธ์ก็เหมือนการปลูกยา ต้องใช้เวลา... ข้าจะรอวันที่ท่านพร้อมนะคะ คืนนี้ฝันดีค่ะ_.png";
        ...
        n4_5C.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(ยืนมองแสงจันทร์เพียงลำพัง) _ไม่ว่ายังไง... ข้าจะยังรอท่านอยู่ที่นี่เสมอนะคะ_2.png";
        ...
        n4_4A.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(ยื่นแหวนเถาวัลย์ถักขนาดเล็กให้) _นี่คือแหวนแห่งพันธสัญญาของคนป่าค่ะ... ใครที่สวมมันไว้ จะไม่มีวันหลงทางกลับมาหาคนที่ให้... ท่านจะลองสวมมันดูไหม_.png";
        ...
        n4_4B.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\_ถ้าท่านยังไม่พร้อมสวมมันตอนนี้ก็ไม่เป็นไรค่ะ... แค่ท่านพกมันไว้ ข้าก็อุ่นใจแล้ว... คืนนี้ท่านพักผ่อนเถอะนะคะ พรุ่งนี้ยังมีเรื่องให้ทำอีกเยอะ_.png";
        ...
        n4_4C.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\_ข้าเข้าใจค่ะ... บางทีความสัมพันธ์ก็เหมือนการปลูกยา ต้องใช้เวลา... ข้าจะรอวันที่ท่านพร้อมนะคะ คืนนี้ฝันดีค่ะ_.png";
        ...
        n4_3A.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(ขยับเข้ามาใกล้ขึ้น) _ที่ข้าทำทั้งหมด... ก็เพราะท่านสำคัญสำหรับข้ามากนะคะ ถ้าวันหนึ่งข้าขอให้ท่านอยู่ช่วยข้าสร้างสวนสมุนไพรที่นี่... ท่านจะยินดีไหม_.png";
        ...
        n4_3B.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(มองตาคุณ) _ข้าเข้าใจค่ะ... ทุกคนมีความฝันของตัวเอง แต่ถ้าความฝันของข้ามีท่านอยู่ด้วย มันคงจะวิเศษมากเลย ท่านว่าไหมคะ_.png";
        ...
        n4_3C.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(ยิ้มเศร้าๆ) _นั่นสินะคะ... ข้าคงจะคาดหวังมากไป แต่ไม่ว่ายังไง ข้าก็ดีใจที่เราได้พบกัน... ท่านจะรับสิ่งนี้ไว้แทนคำสัญญาของข้าได้ไหม_.png";
        ...
        n4_2A.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(หน้าแดงระเรื่อ) _ท่านพูดแบบนี้... หัวใจข้าก็สั่นสิคะ จริงๆ แล้วข้ามีความลับหนึ่งที่ยังไม่เคยบอกใคร ข้าแอบปรุงยา _แห่งความทรงจำ_ ไว้ให้ท่านด้วย..._.png";
        ...
        n4_2B.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\_ท่านช่างเป็นคนที่มีทัศนคติดีจัง... การมีท่านอยู่ด้วยทำให้ป่าที่เคยเงียบเหงาดูมีชีวิตชีวาขึ้นมาทันที ท่าน... เคยคิดเรื่องการลงหลักปักฐานบ้างไหมคะ_.png";
        ...
        n4_2C.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(หัวเราะเบาๆ) _นั่นสินะคะ ท่านคงเหนื่อยมากจริงๆ มานั่งนี่เถอะค่ะ... ข้าเตรียมน้ำมันหอมระเหยสูตรพิเศษไว้ให้ท่านผ่อนคลายโดยเฉพาะเลย_.png";
        ...
        root.imagePath = "image\\Scene\\Arwen\\Scene4\\Even\\(ยืนพิงระเบียงบ้าน มองดูดาว) _ในที่สุดเรื่องวุ่นๆ ในหมู่บ้านก็จบลงเสียที... ข้าไม่เคยคิดเลยว่าจะมีใครสักคนยอมเหนื่อยเพื่อข้าขนาดนี้ ขอบคุณจริงๆ นะคะ_.png";
    ...
    private DialogueNode buildLevel5Tree(MainFrame mainFrame) {
        ...
        endNormal.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ขอบคุณที่รักษาสัญญาค่ะ..._ (ภาพตัดไปที่ทั้งคู่ช่วยกันปรุงยาแบบเพื่อน).png";

        DialogueNode endGood   = new DialogueNode("Arwen", "(ภาพตัดไปที่ทั้งคู่นั่งดูดาวด้วยกัน)\n\n— GOOD ENDING: Partner —", true);
        endGood.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ท่านนี่ตลกเสมอเลยนะ... แต่ข้าก็ชอบ_ (ภาพตัดไปที่ทั้งคู่นั่งดูดาวด้วยกัน)2.png";
        ...
        endBest.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ข้ารักท่านที่สุดเลยค่ะ แชมป์..._ (ภาพตัดไปที่ทั้งคู่สร้างบ้านหลังใหม่ด้วยกัน).png";
        ...
        n5_4A.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\(ซบลงที่อกคุณ) _ข้าแอบทำน้ำหอมกลิ่น _นิรันดร์_ ไว้ให้ท่านด้วย... กลิ่นนี้จะติดตัวเราไปจนแก่เฒ่า ท่านจะอยู่ดมกลิ่นนี้กับข้าทุกวันไหม_.png";
        ...
        n5_4B.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ข้าจะปลูกดอกไม้ให้เต็มสวนเลย... เพื่อต้อนรับทุกเช้าวันใหม่ของเรา ท่านอยากช่วยข้าเลือกเมล็ดพันธุ์ไหม_.png";
        ...
        n5_4C.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ขอให้โชคดีนะคะ... และจำไว้ว่า ที่นี่ต้อนรับท่านเสมอ ไม่ว่าเมื่อไหร่_.png";
        ...
        n5_3A.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\(หยิบแหวนเถาวัลย์สวมให้คุณ) _นี่ไม่ใช่แค่ของที่ระลึกแล้วนะ แต่มันคือพันธสัญญา... ว่าข้าจะเป็นของท่าน และท่านจะเป็นของข้าตลอดไป_.png";
        ...
        n5_3B.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\แค่ได้ยินว่าท่านจะอยู่... ข้าก็ดีใจมากแล้วค่ะ ข้าจะทำทุกวันให้ดีที่สุด เพื่อให้ท่านมีความสุขที่นี่_.png";
        ...
        n5_3C.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\(ยิ้มเศร้าๆ) _ข้าเข้าใจค่ะ... วิถีของนักเดินทางคงหยุดนิ่งไม่ได้ ข้าจะเตรียมเสบียงไว้ให้ท่านสำหรับการเดินทางนะคะ_.png";
        ...
        n5_2A.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\(หน้าแดงระเรื่อ) _สวนของเรา... ฟังแล้วอบอุ่นหัวใจจังค่ะ ท่าน... พร้อมที่จะทิ้งการเดินทางที่แสนวุ่นวาย เพื่อมาอยู่ที่นี่กับข้าไหม_.png";
        ...
        n5_2B.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\_ขอบคุณค่ะ... ถ้าไม่มีท่าน ข้าคงทำไม่ได้แน่ๆ ท่านคะ... จากนี้ไปท่านมีแผนจะเดินทางไปที่ไหนต่อหรือเปล่า_.png";
        ...
        n5_2C.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\นั่นสินะคะ... ท่านคงเหนื่อยมามาก เชิญท่านพักตามสบายเถอะค่ะ ข้าเตรียมชาสมุนไพรไว้ให้แล้ว_.png";
        ...
        root.imagePath = "image\\Scene\\Arwen\\Scene5\\Even\\(ยืนอยู่กลางสวนยาที่บานสะพรั่ง) _แชมป์คะ... ในที่สุดสวนที่ข้าฝันถึงก็สำเร็จแล้ว ข้าไม่เคยคิดเลยว่าจะมีวันที่ได้ยืนอยู่ตรงนี้พร้อมกับท่าน..._.png";
