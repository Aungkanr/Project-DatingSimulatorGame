...
public class Lazel extends NPC {
    ...
    private DialogueNode buildLevel1Tree(MainFrame mainFrame) {
        ...
        n1_5A.imagePath = "image\\Scene\\Lazel\\ซีน1\\ตบหลัง.png";
    ...
    private DialogueNode buildLevel3Tree(MainFrame mainFrame) {
        ...
        DialogueNode n2_3A_ref = new DialogueNode("Lazel",
            "\"โว้ย! ...เออๆ! ดูได้แต่อย่าโวยวายนะ! ...ไอ้มังกรนั่นมันลอบกัดข้า...\"");
        n2_3A_ref.imagePath = "image\\Scene\\Lazel\\Scene2\\_โว้ย! ...เออๆ! ดูได้แต่อย่าโวยวายนะ! ...ไอ้มังกรนั่นมันลอบกัดข้า..._.png";
        ...
        n3_2B.imagePath = "image\\Scene\\Lazel\\Scene3\\_จะให้ข้าเย็นได้ไง! มันหยามเกียรตินักรบนะเว้ย! เจ้าเป็นพวกขี้ขลาดแบบนี้ตั้งแต่เมื่อไหร่ฮะ!_.png";
