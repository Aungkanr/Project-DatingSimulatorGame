...
public class Lazel extends NPC {
    ...
    private DialogueNode buildLevel2Tree() {
        ...
        DialogueNode n2_5B = new DialogueNode("Lazel",
                "\"เออๆ ขอบใจที่ช่วย... ห้ามไปบอกใครนะเว้ย เสียลุคหมด\"");
        ...
        n2_3C.addChoice("(หันกลับมา) \"ไม่เอาหน่า ให้ผมดูเถอะ", n2_3A)
            .addChoice("(เดินจากไป)", endBad)
            .addChoice("โถ่ ยัยขี้แยเอ๊ย แค่นี้ทำเป็นหวงแผล", n2_2B);

        // ===== เชื่อม 2.3A =====
        n2_3A.addChoice("อยู่นิ่งๆ นะ เดี๋ยวผมจัดการเอง... อดทนหน่อยนะ", n2_4A)
            .addChoice("แผลลึกนะเนี่ย... ไปห้องพยาบาลเถอะ", n2_4B)
            .addChoice("อี๋... น่ากลัวว่ะ", n2_4C);
