...
public class LazelNoon extends Lazel {
    ...
    private DialogueNode buildLevel1Tree() {
        ...
        DialogueNode n1_5A = new DialogueNode("Lazel",
            ...
            n1_5A.imagePath = "image\\Scene\\Lazel\\Even\\Scene1\\ตบหลัง.png"; // ใส่รูปที่ต้องการ
    ...
    private DialogueNode buildLevel3Tree() {
        ...
        DialogueNode n3_2B = new DialogueNode("Lazel",
            ...
            n3_3C.imagePath = "image\\Scene\\Lazel\\Even\\Scene3\\_จะให้ข้าเย็นได้ไง! มันหยามเกียรตินักรบนะเว้ย! เจ้าเป็นพวกขี้ขลาดแบบนี้ตั้งแต่เมื่อไหร่ฮะ!_.png"; 
